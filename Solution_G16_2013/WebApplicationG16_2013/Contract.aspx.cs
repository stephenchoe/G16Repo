...
namespace WebApplicationG16_2013
{
    public partial class Contract : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (TradeContext context = new TradeContext())
            {
                ...
                List<FuturesContractView> views = new List<FuturesContractView>();
                foreach (var symbol in futuresSymbols)
                {
                    views.Add(new FuturesContractView(symbol));
                }
    ...
    public class FuturesContractView
    {
        ...
        public FuturesContractView(Futures futuresSymbol)
        {
